...
void InitializeVMTs() {
    ...
    uintptr_t findClientMode = CPatternScanner::Instance()->GetPointer("client.dylib", (unsigned char*)"\x48\x8B\xB7\x00\x00\x00\x00\x48\x8D\x3D\x00\x00\x00\x00\x5D\xE9", "xxx????xxx????xx", 0xA) + 0x4;
